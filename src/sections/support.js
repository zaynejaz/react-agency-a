...
const data = [
  {
    id: 1,
    icon: support,
    title: 'Discover how our connections change lives',
    description: `See some of the clients who we have helped, not only achieve, but surpass their goals, both financially and intrinsically.`,
  },
  {
    id: 2,
    icon: support,
    title: 'Need help or support? We got you! Just say hi!',
    description: `We are here to help you, 24 hours of every single day. Our team is on standby to help you get to where you need to be, always.`,
  },
];
